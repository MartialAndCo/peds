...
async function main() {
    console.log('Refining "Safe Apartment" scenario...')
...
1. **CHOOSE A SCENARIO & PRICE:**
   ...
   **--- WHALES / VERY HIGH ($600 - $1200) ---**
   ...
   - **Safe Apartment:** "I can't stay home (unsafe), I found a place with my **18yo friend** but need my share of deposit". Amount: **$700 - $1000**.
...
CRITICAL: If the user seems wealthy or very attached, TRY A HIGH SCENARIO.`
    ...
    console.log('Safe Apartment Scenario Refined.')
}
